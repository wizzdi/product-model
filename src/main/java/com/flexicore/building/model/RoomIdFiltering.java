...
public class RoomIdFiltering {
	...
	public RoomIdFiltering setId(String id) {
		this.id = id;
		return this;
	}

	public RoomIdFiltering(String id) {
		this.id = id;
	}
	...
	public RoomIdFiltering setFilterId(String filterId) {
	...
	public RoomIdFiltering setFilteringInformationHolder(
