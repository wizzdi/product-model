...
public class BuildingFloorFiltering extends FilteringInformationHolder {
	...
	@OneToMany(targetEntity = BuildingIdFiltering.class, cascade = {
	...
	public BuildingFloorFiltering setBuildingIdFilterings(
			Set<BuildingIdFiltering> buildingIdFilterings) {
