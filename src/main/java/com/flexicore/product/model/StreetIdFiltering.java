...
@Entity
public class StreetIdFiltering {
    ...
    public StreetIdFiltering setId(String id) {
        this.id = id;
        return this;
    }

    public StreetIdFiltering(String id) {
        this.id = id;
    }
    ...
    public StreetIdFiltering setFilterId(String filterId) {
    ...
    public StreetIdFiltering setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
