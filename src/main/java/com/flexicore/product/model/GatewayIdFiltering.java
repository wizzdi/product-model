...
@Entity
public class GatewayIdFiltering {
    ...
    public GatewayIdFiltering setId(String id) {
        this.id = id;
        return this;
    }

    public GatewayIdFiltering(String id) {
        this.id = id;
    }
    ...
    public GatewayIdFiltering setFilterId(String filterId) {
    ...
    public GatewayIdFiltering setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
