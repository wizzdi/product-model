...
@Entity
public class ExternalServerIdFiltering {
    ...
    public ExternalServerIdFiltering() {
    }
    ...
    public ExternalServerIdFiltering setId(String id) {
        this.id = id;
        return this;
    }

    public ExternalServerIdFiltering(String id) {
        this.id = id;
    }
    ...
    public ExternalServerIdFiltering setFilterId(String filterId) {
    ...
    public ExternalServerIdFiltering setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
