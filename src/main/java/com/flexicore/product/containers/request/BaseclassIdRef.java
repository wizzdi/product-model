...
public class BaseclassIdRef {
    ...
    public BaseclassIdRef setId(String id) {
        this.id = id;
        return this;
    }

    public BaseclassIdRef(String id) {
        this.id = id;
    }
    ...
    public BaseclassIdRef setFilterId(String filterId) {
    ...
    public BaseclassIdRef setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
