...
@Entity
public class TargetBaseclassIdRef {
    ...
    public TargetBaseclassIdRef setId(String id) {
        this.id = id;
        return this;
    }

    public TargetBaseclassIdRef(String id) {
        this.id = id;
    }
    ...
    public TargetBaseclassIdRef setFilterId(String filterId) {
    ...
    public TargetBaseclassIdRef setFilteringInformationHolder(FilteringInformationHolder filteringInformationHolder) {
